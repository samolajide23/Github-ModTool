...
export const buildInstallSettingsHelpText = (subredditName: string): string => {
  ...
  return [
    ...
    '',
    'Method C — from the subreddit (not the mod queue):',
    '1. Open https://www.reddit.com/r/' + sub,
    '2. Click ⋯ (three dots) next to Create Post',
    '3. Use “Configure QueueIQ settings” for steps, or other QueueIQ menu items',
    '',
